...
There are two feedback loops on top of this sequence: Quality Check can send work back to Processing (feedback), and Delivery can send work back to Quality Check (review).
