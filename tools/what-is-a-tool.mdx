...
<CardGroup cols={2}>
  <Card title="Agent Tool" href="/tools/agents">
    Trigger another agent as a tool
    <Badge variant="default">Default</Badge>
  </Card>
  <Card title="Workflow" href="/tools/workflow">
    Run a predefined workflow with custom input
    <Badge variant="default">Default</Badge>
  </Card>
  <Card title="API Request" href="/tools/api-requests">
    Make HTTP requests to any REST API with full configuration control
    <Badge variant="default">Default</Badge>
  </Card>
  <Card title="Email" href="/tools/email">
    Send email messages through configured providers
    <Badge variant="default">Default</Badge>
  </Card>
  <Card title="Perplexity AI" href="/tools/perplexity-ai">
    Web search and research capabilities powered by Perplexity AI
    <Badge variant="pro">Pro</Badge>
  </Card>
  <Card title="Web Search & Browser" href="/tools/browser-tool">
    Web scraping and browser automation with ScraperAPI integration
    <Badge variant="default">Default</Badge>
  </Card>
  <Card title="Office Documents" href="/tools/office-documents">
    Generate and edit Word, Excel, PowerPoint, and PDF documents
    <Badge variant="default">Default</Badge>
  </Card>
  <Card title="External Data Source" href="/tools/external-datasource">
    Connect to external databases and data sources
    <Badge variant="pro">Pro</Badge>
  </Card>
  <Card title="MCP Server" href="/tools/mcp-servers">
...
<AccordionGroup>
  <Accordion title="Agent Tool">
    **Purpose**: Trigger another agent as a tool
  ...
  <Accordion title="Workflow Tool">
    **Purpose**: Execute predefined workflows with custom input
...
<AccordionGroup>
  ...
  <Accordion title="Email Tool">
    **Purpose**: Send email messages through configured providers
...
<AccordionGroup>
  ...
  <Accordion title="Office Documents Tool">
    **Purpose**: Generate and edit Word, Excel, PowerPoint, and PDF documents
