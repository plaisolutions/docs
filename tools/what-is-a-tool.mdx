...
<CardGroup cols={2}>
  <Card title="Agent Tool" icon="bot" href="/tools/agents">
    Trigger another agent as a tool
    <Badge variant="default">Default</Badge>
  </Card>
  <Card title="Workflow" icon="workflow" href="/tools/workflow">
  ...
  <Card title="Email" icon="mail" href="/tools/email">
  ...
  <Card title="Browser" icon="globe" href="/tools/browser-tool">
    Web scraping and browser automation with ScraperAPI integration
    <Badge variant="default">Default</Badge>
  </Card>
  <Card title="Office Documents" icon="file-text" href="/tools/office-documents">
...
2. **Cache Check**
   ...
   - **Miss** — execute the tool, cache the result, then return the result
