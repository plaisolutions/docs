...
When you enable **streaming** for an agent, you can interact with it through the **Conversational Chat** interface in PLai. This is the interactive chat experience for users and team members.
