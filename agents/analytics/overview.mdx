...
The same dashboard covers both modes: flip Live Mode on for a real-time feed of what's happening right now, or leave it off to browse historical conversations by date range and run AI-generated analysis on them.
