...
Live Mode only shows activity from the moment you turn it on — it won't display anything that happened earlier, and the date range filter is disabled while it's active. Switch it off to go back to browsing historical conversations.
