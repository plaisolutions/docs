...
All variants are searched → Results combined and deduplicated → Agent uses comprehensive results
```
...
Result: Agent can use Google Search, Link Preview, 
        plus custom tools (API, BigQuery, Code)
```
