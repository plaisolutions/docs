...
A filter works best when it's scoped to one specific, narrow question rather than a broad topic, with enough example phrasings for the agent to recognize real variations of it. Planning this scope up front saves you from rebuilding the filter later.
