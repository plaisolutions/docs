...
Every agent starts with a default **INPUT guardrail** already active, so you're never configuring from a blank slate. This guide shows how to extend that baseline with **OUTPUT guardrails** and fully custom rules tailored to your use case.
